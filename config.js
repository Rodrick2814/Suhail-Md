...
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "971522424171";
...
module.exports = {
  ...
  author : process.env.PACK_AUTHER|| "CHERI LADY",
  packname: process.env.PACK_NAME || "",
  botname : process.env.BOT_NAME  || "2814",
  ownername:process.env.OWNER_NAME|| "CHERI ",


  errorChat : process.env.ERROR_CHAT || "COMMAND NOT FOUND",
